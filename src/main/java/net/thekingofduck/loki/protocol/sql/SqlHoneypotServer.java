package net.thekingofduck.loki.protocol.sql;
...
import net.thekingofduck.loki.service.SqlAuditService;
...
public class SqlHoneypotServer {
    ...
    static class Handler implements Runnable {
                ...
                while (true) {
                    ...
                    if (cmd == 0x01) { // COM_QUIT
                        ...
                        if (equalsIgnoreCaseNoSpace(sql, "select version()") || equalsIgnoreCaseNoSpace(sql, "select @@version") ) {
                            // 发起单列版本号结果集
                            byte[][] rs = singleColumnResult("version()", "5.7.31-Loki");
        ...
        private byte[] handshakePacket() {
            ...
            byte[] serverVersion = strz("5.7.31-Loki");
