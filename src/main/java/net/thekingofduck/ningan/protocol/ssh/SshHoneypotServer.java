package net.thekingofduck.ningan.protocol.ssh;
...
import net.thekingofduck.ningan.service.SshAuditService;
...
public class SshHoneypotServer {
    ...
    public SshHoneypotServer(int port) {
        this(port, "Welcome to ningan SSH Honeypot\r\n");
    }
