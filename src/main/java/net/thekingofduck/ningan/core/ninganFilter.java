 ...
 */
public class ninganFilter implements Filter{
    ...
    @Value("${ningan.adminPort}")
    private Integer adminPort;

    @Value("${ningan.adminPath}")
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        log.info("ningan Filter is init.... ");
    }
   ...
   public String getHeaders(HttpServletRequest request){
    ...
    @Override
    public void destroy() {
        log.info("ningan Filter was destroyed....");
    }
}
