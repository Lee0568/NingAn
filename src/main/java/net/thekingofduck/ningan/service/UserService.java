...
import net.thekingofduck.ningan.entity.UserInfoEntity;
        ...
        if (command == null || command.trim().isEmpty()) {
            ...
            switch (lowerCaseCommand) {
                ...
                case "pwd":
                    ...
                    break;
                case "cat /etc/passwd":
                    response = "root:x:0:0:root:/root:/bin/bash\nninganuser:x:1000:1000:ningan User:/home/ninganuser:/bin/bash";
                    break;
                case "id":
                    response = "uid=1000(ninganuser) gid=1000(ninganuser) groups=1000(ninganuser)";
                    break;
                case "help":
